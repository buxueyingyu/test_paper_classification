...
class Cutmix:
    ...
    def distort(self, batch_imgs, one_hot_batch_labels):
        if np.random.uniform() < self.prob:
            ...
            batch_imgs[:, box[1]:box[3], box[0]:box[2]] = batch_imgs_copy[random_batch_indexes, box[1]:box[3],
                                                          box[0]:box[2]]
            one_hot_batch_labels = (1. - cut_ratio) * one_hot_batch_labels + cut_ratio * one_hot_batch_labels[
                random_batch_indexes]
